...
import { fetchList_black, valid_black, invalid_black, deleteIp_black } from '@/api/ip'
import Pagination from '@/components/Pagination' // secondary package based on el-pagination
import Add from './add_black.vue'
export default {
  ...
  methods: {
    getList() {
      ...
      fetchList_black(this.listQuery).then(data => {
    ...
    delIP(id, idx) {
      deleteIp_black({ id: id }).then(response => {
        this.$message({
          message: '删除成功！',
          type: 'success'
        })
